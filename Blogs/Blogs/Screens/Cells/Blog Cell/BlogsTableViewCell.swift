...
final class BlogsTableViewCell: UITableViewCell, BlogCellModelRepresentable {
    ...
    private func addlayoutSubviews() {
        ...
        NSLayoutConstraint.activate([
            blogView.topAnchor.constraint(equalTo: self.topAnchor,
                                          constant: CGFloat.standartIdentConstant - 8),
            blogView.bottomAnchor.constraint(equalTo: self.bottomAnchor,
                                             constant: -(CGFloat.standartIdentConstant - 8)),
            blogView.leadingAnchor.constraint(equalTo: self.leadingAnchor,
                                              constant: CGFloat.standartIdentConstant),
            blogView.trailingAnchor.constraint(equalTo: self.trailingAnchor,
                                               constant: -CGFloat.standartIdentConstant),
            
            shadowView.topAnchor.constraint(equalTo: blogView.topAnchor,
            ...
            shadowView.bottomAnchor.constraint(equalTo: blogView.bottomAnchor,
                                               constant: CGFloat.shadowIdentConstant),
            
            avatar.topAnchor.constraint(equalTo: blogView.topAnchor,
                                        constant: CGFloat.standartIdentConstant),
            avatar.leadingAnchor.constraint(equalTo: blogView.leadingAnchor,
                                            constant: CGFloat.standartIdentConstant),
            
            dateSubTitle.bottomAnchor.constraint(equalTo: blogView.bottomAnchor,
                                                 constant: -CGFloat.standartIdentConstant),
            dateSubTitle.leadingAnchor.constraint(equalTo: blogView.leadingAnchor,
                                                  constant: CGFloat.standartIdentConstant),
            ...
            nameSubTitle.leadingAnchor.constraint(equalTo: blogView.leadingAnchor,
                                                  constant: CGFloat.standartIdentConstant),
            ...
            title.topAnchor.constraint(equalTo: blogView.topAnchor,
                                       constant: CGFloat.titleBlogCellIdentConstant),
            title.leadingAnchor.constraint(equalTo: blogView.leadingAnchor,
                                           constant: CGFloat.standartIdentConstant),
            title.trailingAnchor.constraint(lessThanOrEqualTo: blogView.trailingAnchor,
                                            constant: -CGFloat.standartIdentConstant),
            title.bottomAnchor.constraint(lessThanOrEqualTo: nameSubTitle.topAnchor,
                                          constant: -CGFloat.standartIdentConstant/2),
